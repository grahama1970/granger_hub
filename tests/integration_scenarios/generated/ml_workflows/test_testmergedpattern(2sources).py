"""
Auto-generated test for Merged Pattern (2 sources) with optimizations

Generated from patterns: Merged Pattern (2 sources)
...
class Merged Pattern (2 sources)(ScenarioTestBase):
